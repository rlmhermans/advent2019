...
public class Droid {
    ...
    public void run() {
        ...
        for (int y = 0; y < sizeY; y++) {
            for (int x = 0; x < sizeX; x++) {
                if (view[y][x] == '#' && y != 0 && y != sizeY - 1 && x != 0 && x != sizeX - 1) {
    ...
    public void output(int value) {
        if (value == 10) {
            ...
            view[currentY][currentX] = (char) value;
            currentX++;
        }
    }
}
