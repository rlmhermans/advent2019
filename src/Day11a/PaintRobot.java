...
public class PaintRobot {
    ...
    private final int exteriorSize = 200;
    ...
    private boolean[][] paintedOnce = new boolean[exteriorSize][exteriorSize];
    ...
    public void paintWhite() {
        paintedOnce[positionY][positionX] = true;
